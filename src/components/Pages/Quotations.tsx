        ...
        <head>
          ...
          <style>
            ...
            * { box-sizing: border-box; }
            ...
            .item-desc { margin-top: 4px; font-size: 12px; color: var(--muted); }
            ...
            .signature .name { margin-top: 52px; font-weight: 600; color: var(--accent); }
          </style>
        </head>
        <body>
          <div class="page">
            <div class="top">
              ...
              <div class="quote-title">
                ...
                <div class="quote-meta">
                  <div><span>Quote no.</span><strong>${escapeHtml(quotation.quotation_number || '-')}</strong></div>
                  <div><span>Quote date</span><strong>${formatShortDate(quotation.created_at)}</strong></div>
                  <div><span>Due</span><strong>${formatShortDate(validUntil.toISOString())}</strong></div>
                </div>
              </div>
            </div>
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th style="width: 120px; text-align:center;">Pengiriman</th>
            ...
            <div class="summary-grid">
              <div class="payment">
                ...
                <p>Penawaran berlaku hingga ${formatShortDate(validUntil.toISOString())}.</p>
                <p>RFQ#: ${escapeHtml(quotation.rfqs?.rfq_number || '-')}</p>
              </div>
              <div class="totals">
                <div class="totals-row"><span>Subtotal</span><strong>Rp ${formatRupiah(subtotalAmount)}</strong></div>
                <div class="totals-row"><span>Pajak</span><strong>Rp ${formatRupiah(taxAmount)}</strong></div>
