        ...
        <head>
          ...
          <style>
            ...
            * { box-sizing: border-box; }
            ...
            .footer { margin-top: 28px; padding-top: 12px; border-top: 1px solid var(--border); font-size: 12px; color: var(--muted); display: flex; justify-content: flex-end; gap: 16px; }
          </style>
        </head>
        <body>
          <div class="page">
            ...
            <div class="footer">
              ...
              <div>Telepon: ${escapeHtml(settings?.phone || '-')}</div>
            </div>
          </div>
        </body>
      </html>
