      ...
      <html lang="id">
        <head>
          ...
          <style>
            ...
            .company h1 { margin: 8px 0 4px; font-size: 22px; text-transform: uppercase; letter-spacing: 0.08em; }
        ...
        <body>
          ...
          <div class="section">
            ...
            <div class="two-col">
              <div class="client-info">
                ...
                <p><strong>Company:</strong> ${escapeHtml(quotation.company_name || '-')}</p>
                <p><strong>Address:</strong> ${escapeHtml(quotation.client_address || '-')}</p>
                <p><strong>PIC:</strong> ${escapeHtml(quotation.pic_name || '-')}</p>
                <p><strong>Email:</strong> ${escapeHtml(quotation.pic_email || '-')}</p>
                <p><strong>Phone:</strong> ${escapeHtml(quotation.pic_phone || '-')}</p>
              </div>
              <div class="meta">
          ...
          <div class="section terms">
            ...
            <ul>
              <li>Prices listed above are exclusive of tax and may be subject to applicable taxes.</li>
              <li>Payment term: ${
                quotation.payment_time ? `${escapeHtml(`${quotation.payment_time}`)} days` : '-'
              } after invoice date.</li>
              <li>This offer is valid until ${formatShortDate(validUntil.toISOString())}.</li>
              <li>Please confirm acceptance by replying with a signed confirmation or purchase order.</li>
            </ul>
          </div>
          <div class="signature">
