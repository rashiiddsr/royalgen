      ...
      <html lang="id">
        ...
        <body>
          ...
          <div class="section">
            <div class="two-col">
              <div class="meta">
                <p><strong>Company:</strong> ${escapeHtml(delivery.company_name || order?.company_name || '-')}</p>
                <p><strong>Ship Address:</strong> ${escapeHtml(delivery.ship_address || '-')}</p>
          ...
          <div class="signature">
            ...
            <div class="box">
              <div>Penerima,</div>
              <div class="name">${escapeHtml(delivery.company_name || order?.company_name || '-')}</div>
            </div>
          </div>
        </body>
      </html>
