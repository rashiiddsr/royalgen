          ...
          <div className="bg-white rounded-xl shadow-lg w-full max-w-5xl mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    PO Number {useQuotation && <span className="text-red-500">*</span>}
                  </label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Company {!useQuotation && <span className="text-red-500">*</span>}
                  </label>
                  {useQuotation ? (
                    <input
                      type="text"
                    ...
                    <div className="space-y-3">
                      <div className="relative">
                        ...
                        <input
                          ...
                          required={!useQuotation && !formData.client_id}
                        />
                      </div>
                      {formData.client_id ? (
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    PIC Name {!useQuotation && <span className="text-red-500">*</span>}
                  </label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    PIC Email {!useQuotation && <span className="text-red-500">*</span>}
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    PIC Number {!useQuotation && <span className="text-red-500">*</span>}
                  </label>
                  {useQuotation ? (
                    <input
                      type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Payment Time {!useQuotation && <span className="text-red-500">*</span>}
                  </label>
                  <input
